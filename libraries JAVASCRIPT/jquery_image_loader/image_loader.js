 ...
 * PARAMS: complete: function(e, img){}, progress: function(e, img){}, start: function(e, img){}, error: function(e, img){}
 * samples:
 <script>
...
jQuery(function($){
    $.fn.load_img = function(params){
        var settings = $.extend({complete: function(e, img){}, progress: function(e, img){}, start: function(e, img){}, error: function(e, img){}}, params);
        $(this).each(function(){
            var img = $(this);
            if(typeof XMLHttpRequest === "undefined"){
                ...
                try{request.addEventListener('progress',function(e){ settings.progress(e, img); }, false);} catch(e){ request.onreadystatechange=function() { if (request.readyState==4 && request.status==200) { settings.complete(img); } } } //ie7, 8 fix
                request.onload = function(){ try{ img.attr("src", "data:image/jpeg;base64," + base64Encode_(request.responseText));  }catch(e){} settings.complete(img); };
                request.open("GET", img.attr("src"), true);
                request.onerror = function(e){ settings.error(e, img); }
