...
function openmanager(field_name, url, type, win) {
    ...
    var strUploadPath = encodeURI(tinyMCE.activeEditor.getParam('open_manager_upload_path'));
    var strPluginPath = tinyMCE.activeEditor.plugins.openmanager.getPluginURL();						// get the path to the uploader plugin
    var strUploaderURL = strPluginPath + "/index.html?type="+type+"&message=Drag your file or click here.&upload_path="+strUploadPath+"&max_size=10";												// generate the path to the uploader script
